...
class FlickrFetchr {
    ...
    init{
        ...
        val retrofit: Retrofit = Retrofit.Builder()
            //builder is an interface to build retrofit instance onto
            .baseUrl("https://api.flickr.com/")
            .addConverterFactory(GsonConverterFactory.create())//string converter b4 call result
            .client(client)
            .build()
